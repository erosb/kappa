...
public class PathParamConverterTest {
  ...
  public void pathMatrixNotExplodedPrimitive() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixNotExplodedPrimitive", ";matrixNotExplodedPrimitive=5");
    ParamChecker.checkPrimitive(nodes, "matrixNotExplodedPrimitive");
  }

  @Test
  public void pathMatrixExplodedPrimitive() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixExplodedPrimitive", ";matrixExplodedPrimitive=5");
    ParamChecker.checkPrimitive(nodes, "matrixExplodedPrimitive");
  }

  @Test
  public void pathMatrixNotExplodedArray() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixNotExplodedArray", ";matrixNotExplodedArray=3,4,5");
    ParamChecker.checkArray(nodes, "matrixNotExplodedArray");
  }

  @Test
  public void pathMatrixExplodedArray() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixExplodedArray",
      ";matrixExplodedArray=3;matrixExplodedArray=4;matrixExplodedArray=5");
    ParamChecker.checkArray(nodes, "matrixExplodedArray");
  }

  @Test
  public void pathMatrixNotExplodedObject() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixNotExplodedObject",
      ";matrixNotExplodedObject=boolProp,true,stringProp,admin");
    ParamChecker.checkObject(nodes, "matrixNotExplodedObject");
  }

  @Test
  public void pathMatrixExplodedObject() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("matrixExplodedObject", ";boolProp=true;stringProp=admin");
    ParamChecker.checkObject(nodes, "matrixExplodedObject");
  }

  @Test
  public void pathContentObject() throws Exception {
    Map<String, IJsonValue> nodes = pathToNode("content", "{\"boolProp\":true,\"stringProp\":\"admin\"}");
  ...
  public void noPathPattern() {
    ...
    Map<String, IJsonValue> values = ParameterConverter.pathToNode(null, parameters, null, "/foo");
    assertNotNull(values);
    assertTrue(values.isEmpty());
  }

  private Map<String, IJsonValue> pathToNode(String parameterName, String value) throws Exception {
